...
import { SubmitDetailsSchema, SubmitDetailsSchemaType } from "@/app/schemas/customer.schema";
...
function createCustomerAction(arg0: any): { success: any; message: any; } | PromiseLike<{ success: any; message: any; }> {
