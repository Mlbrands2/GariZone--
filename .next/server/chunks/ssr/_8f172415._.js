...
function useQueryState(key, { history = "replace", shallow = true, scroll = false, throttleMs = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FLUSH_RATE_LIMIT_MS"], parse = (x)=>x, serialize = String, eq = (a, b)=>a === b, defaultValue = void 0, clearOnDefault = true, startTransition } = {
    history: "replace",
    scroll: false,
    shallow: true,
...
class Ky {
    static create(input, options) {
        ...
        const function_ = async ()=>{
            ...
            if (ky._options.onDownloadProgress) {
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ky$2f$distribution$2f$utils$2f$body$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["streamResponse"])(response.clone(), ky._options.onDownloadProgress);
            }
            return response;
        };
    ...
    constructor(input, options = {}){
        ...
        if (this._options.onUploadProgress) {
            ...
            if (originalBody) {
                this.request = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ky$2f$distribution$2f$utils$2f$body$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["streamRequest"])(this.request, this._options.onUploadProgress);
            }
        }
    }
...
//# sourceMappingURL=_8f172415._.js.map